...
buffer rb 100
msg_wait db "Wait for the other player to finish their turn", 0
msg_win db "You won", 0
msg_loose db "You lost", 0
msg_score db "Your current score is ", 0
msg_last db "Your last card is ", 0
msg_options db "You can take a new card by writing 1 or pass the turn by writing 0", 0
msg_over db "Your score is equal or higher than 21. Your score is ", 0
msg_draw db "Draw", 0
